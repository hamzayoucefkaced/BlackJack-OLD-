    ...
    case 1:
     {
      ...
      try {
       ...
       case 7:
        {
         value = 8;File frames = new File("C:/Users/Hamza/Desktop/Programming shit/BlackJack/8.png");
         try {
          image = ImageIO.read(frames);
         } catch (IOException e) {
          e.printStackTrace();
       ...
       case 8:
        {
         value = 9;File frames = new File("C:/Users/Hamza/Desktop/Programming shit/BlackJack/9.png");
         try {
          image = ImageIO.read(frames);
         } catch (IOException e) {
          e.printStackTrace();
       ...
       case 9:
        {
         value = 10;File frames = new File("C:/Users/Hamza/Desktop/Programming shit/BlackJack/q.png");
         try {
          image = ImageIO.read(frames);
         } catch (IOException e) {
          e.printStackTrace();
       ...
       case 10:
        {
         value = 10;File frames = new File("C:/Users/Hamza/Desktop/Programming shit/BlackJack/j.png");
         try {
          image = ImageIO.read(frames);
         } catch (IOException e) {
          e.printStackTrace();
       ...
       case 11:
        {
         value = 10;File frames = new File("C:/Users/Hamza/Desktop/Programming shit/BlackJack/k.png");
         try {
          image = ImageIO.read(frames);
         } catch (IOException e) {
          e.printStackTrace();
